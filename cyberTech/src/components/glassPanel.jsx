...
export const GlassPanel=({text})=>{
  ...
  <div className="h-full w-full  bg-[#0b1727]/10 rounded-2xl backdrop-blur-md border border-white/10 flex flex-col md:items-center justify-center text-center text-white">
